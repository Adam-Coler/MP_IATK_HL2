...
namespace Photon_IATK
{
    ...
    /// <summary>
    /// Visualisation editor. Custom editor for inspector in Visualisation component. This is coppied directly and full from IATK code, it is being used to allow a custom vis wrapper class for NuiLab use
    /// </summary>
    [CustomEditor(typeof(VisWrapperClass))]
    [CanEditMultipleObjects]
    public class CopyOfIATKVisualisationEditor : Editor
    {
